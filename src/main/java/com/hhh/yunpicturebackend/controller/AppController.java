...
import com.hhh.yunpicturebackend.model.dto.app.*;
...
import com.hhh.yunpicturebackend.service.ProjectDownloadService;
...
public class AppController {
    ...
    public Flux<ServerSentEvent<String>> chatToGenCode(@RequestParam Long appId, @RequestParam String message,@RequestParam List<String> imageUrls, HttpServletRequest request) {
        //参数校验
        ...
        //调用服务生成代码（SSE流式返回）
        Flux<String> contentFlux = appService.cahttoGenCode(appId, message,imageUrls, loginUser);
        return contentFlux
                // 过滤掉null值以防止NPE
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.hhh.yunpicturebackend.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
    ...
    public void downloadAppCode(@PathVariable Long appId,
        ...
        if (!app.getUserId().equals(loginUser.getId())) {
            throw new BusinessException(ErrorCode.NO_AUTH, "无权限下载该应用代码");
        }
