...
import com.hhh.yunpicturebackend.model.enums.SpaceRoleEnum;
import com.hhh.yunpicturebackend.model.enums.SpaceTypeEnum;
...
public class SpaceServiceImpl extends ServiceImpl<SpaceMapper, Space>
    ...
    public long addSpace(SpaceAddRequest spaceAddRequest, User loginUser) {
        ...
        ThrowUtils.throwIf(space.getSpaceLevel() != SpaceLevelEnum.COMMON.getValue() && !userService.isAdmin(loginUser), ErrorCode.NO_AUTH, "无权限创建指定级别的空间");
        ...
        synchronized (lock){
            Long newSpaceId = transactionTemplate.execute(status -> {
                ...
                //为了方便部署注释掉分表
                /*//创建分表(仅对团队空间生效)
                dynamicShardingManager.creatSpacePictureTable( space);*/
                //返回空间id
                return space.getId();
            });
    ...
    public void fillSpaceBySpaceLevel(Space space) {
        ...
        if (spaceLevelEnum != null) {
            ...
            if (space.getMaxSize() == null) {
                ...
                space.setMaxSize(space.getMaxSize()*1024*1024);
            }
    ...
    public void checkSpaceAuth(User loginUser, Space space) {
        //仅本人或管理员可编辑
        ThrowUtils.throwIf(!space.getUserId().equals(loginUser.getId()) && !userService.isAdmin(loginUser), ErrorCode.NO_AUTH);
    }
