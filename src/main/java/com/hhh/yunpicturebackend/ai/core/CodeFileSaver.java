...
import static com.hhh.yunpicturebackend.constant.AppConstant.CODE_OUTPUT_ROOT_DIR;

@Deprecated
public class CodeFileSaver {

    // 文件保存根目录
    private static final String FILE_SAVE_ROOT_DIR = System.getProperty("user.dir") + CODE_OUTPUT_ROOT_DIR;
